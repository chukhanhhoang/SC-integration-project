/*********************** dSPACE target specific file *************************
   ...
   Include file Sensors_and_actuators_ball_and_plate_rti.c:
...
#define RTB_STRUCTURE_NAME             Sensors_and_actuators_ball_an_B
#define RTP_STRUCTURE_NAME             Sensors_and_actuators_ball_an_P
...
static void rti_mdl_initialize_io_units(void)
{
  ...
  /* dSPACE I/O Board DSETHERNET #1 Unit:RXUDP */
  {
    ...
    Sensors_and_actuators_ball_an_Y.Status = (uint32_T) 4;

    /* set output Received Frames initially to 0 */
    Sensors_and_actuators_ball_an_Y.Frames = (real_T) 0;
    ...
    *((UInt32*) Sensors_and_actuators_ball_an_B.SFunction1_o5) = (UInt32) 0;

    /* set output Remote Port initially to 0 */
    Sensors_and_actuators_ball_an_B.SFunction1_o6 = (uint16_T) 0;
  }
...
__INLINE void rti_mdl_sample_input(void)
{
  ...
  /* --- [RTIEMC, Encoder] - DIO class: 2 - Unit: 1 - Port: 1 - Channel: 1 --- */
  {
    ...
    DioCl2EncoderIn_getEncVelocity(pRTIEmcEncoder_Unit_1_DioCl_2_Port_1_Ch1,
      &speedOrAngVelocity);
    Sensors_and_actuators_ball_an_B.SFunction1_o1_o = (real_T) positionOrAngle;
    Sensors_and_actuators_ball_an_B.SFunction1_o2_n = (real_T)
      speedOrAngVelocity;
  }
  ...
  /* --- [RTIEMC, Encoder] - DIO class: 2 - Unit: 2 - Port: 1 - Channel: 3 --- */
  {
    ...
    DioCl2EncoderIn_getEncVelocity(pRTIEmcEncoder_Unit_2_DioCl_2_Port_1_Ch3,
      &speedOrAngVelocity);
    Sensors_and_actuators_ball_an_B.SFunction1_o1_g = (real_T) positionOrAngle;
    Sensors_and_actuators_ball_an_B.SFunction1_o2_p = (real_T)
      speedOrAngVelocity;
  }
  ...
  /* --- [RTIEMC, Encoder] - DIO class: 2 - Unit: 3 - Port: 1 - Channel: 5 --- */
  {
    ...
    DioCl2EncoderIn_getEncVelocity(pRTIEmcEncoder_Unit_3_DioCl_2_Port_1_Ch5,
      &speedOrAngVelocity);
    Sensors_and_actuators_ball_an_B.SFunction1_o1 = (real_T) positionOrAngle;
    Sensors_and_actuators_ball_an_B.SFunction1_o2 = (real_T) speedOrAngVelocity;
  }
}
