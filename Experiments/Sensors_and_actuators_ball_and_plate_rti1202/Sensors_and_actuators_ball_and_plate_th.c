/************************ dSPACE target specific file *************************
   ...
   Include file .\Sensors_and_actuators_ball_and_plate_rti1202\Sensors_and_actuators_ball_and_plate_th.c :

   Task Configuration file for model : Sensors_and_actuators_ball_and_plate

   RTI1202 7.15 (02-Nov-2020)/2.20
   01-Jun-2021 17:40:28
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Sensors_and_actuators_ball_and_plate_rti1202\Sensors_and_actuators_ball_and_plate_th.c is for ST).
# endif
