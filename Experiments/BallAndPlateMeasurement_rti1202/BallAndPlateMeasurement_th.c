/************************ dSPACE target specific file *************************
   ...
   Include file .\BallAndPlateMeasurement_rti1202\BallAndPlateMeasurement_th.c :

   Task Configuration file for model : BallAndPlateMeasurement

   RTI1202 7.15 (02-Nov-2020)/2.20
   01-Jun-2021 17:08:15
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\BallAndPlateMeasurement_rti1202\BallAndPlateMeasurement_th.c is for ST).
# endif
